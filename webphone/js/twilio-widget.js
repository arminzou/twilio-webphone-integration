...
function addDtmfListener() {
    ...
    // Create a new Tone instance. (Initialised it with 
    ...
    $(".dtmf-interface .btn-group .numpad-button", twAttr.iframeDocument).on("mousedown touchstart", function (e) {
        e.preventDefault();
    ...
    $(".dtmf-interface .btn-group .numpad-button", twAttr.iframeDocument).on("mouseup touchend", function () {
